...
public class Address
{
    ...
    [Required, MinLength(5, ErrorMessage = "Please use an Address bigger than 5 letter."), MaxLength(100, ErrorMessage = "Please use an Address less than 100 letters.")]
    ...
    [Required, RegularExpression(@"^([0-9]{5})$", ErrorMessage = "Please use a valid Postal Code with 5 numbers.")]
